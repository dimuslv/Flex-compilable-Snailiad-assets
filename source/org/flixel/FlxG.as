package org.flixel
{
	...
	public class FlxG
	{
		 ...
		 */
		static public function playMusic(Music:Class,Volume:Number=1.0,param3:Number = 0):void
		{
			if(music == null)
				music = new FlxSound();
		...
		static public function set musicVolume(Volume:Number):void
		{
			_musicVolume = Volume;
			if(_musicVolume < 0)
				_musicVolume = 0;
		 ...
		 */
		static public function follow(Target:FlxObject, Lerp:Number=1, param3:Boolean=true):void
		{
			followTarget = Target;
			followLerp = Lerp;
