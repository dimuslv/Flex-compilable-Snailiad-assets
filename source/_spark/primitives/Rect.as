package spark.primitives
{
   ...
   public class Rect extends FilledElement
   {
      ...
      override public function getBoundsXAtSize(param1:Number, param2:Number, param3:Boolean = true) : Number
      {
         ...
         var _loc5_:Matrix = mx_internal::getComplexMatrix(param3);
         if(!_loc5_)
         {
         ...
         var _loc6_:Point = MatrixUtil.fitBounds(param1,param2,_loc5_,preferredWidthPreTransform(),preferredHeightPreTransform(),minWidth,minHeight,maxWidth,maxHeight);
         if(!_loc6_)
         {
