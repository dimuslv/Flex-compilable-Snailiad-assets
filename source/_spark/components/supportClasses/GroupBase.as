   ...
   public class GroupBase extends UIComponent implements IViewport
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.luminositySettingsChanged)
         {
            ...
            {
               _loc5_ = int(this._mask.filters.length);
               _loc4_ = 0;
               while(_loc4_ < _loc5_)
               {
      ...
      override public function globalToLocal(param1:Point) : Point
      {
         ...
         {
            _loc2_ = Number(mx_internal::_layoutFeatures.stretchX);
            _loc3_ = Number(mx_internal::_layoutFeatures.stretchY);
      ...
      override public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         if(param1 == MouseEvent.CLICK || param1 == MouseEvent.DOUBLE_CLICK || param1 == MouseEvent.MOUSE_DOWN || param1 == MouseEvent.MOUSE_MOVE || param1 == MouseEvent.MOUSE_OVER || param1 == MouseEvent.MOUSE_OUT || param1 == MouseEvent.ROLL_OUT || param1 == MouseEvent.ROLL_OVER || param1 == MouseEvent.MOUSE_UP || param1 == MouseEvent.MOUSE_WHEEL)
         {
