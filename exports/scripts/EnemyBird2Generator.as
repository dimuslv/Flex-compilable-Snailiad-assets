package
{
   ...
   public class EnemyBird2Generator extends Enemy
   {
      ...
      public function EnemyBird2Generator(param1:int, param2:int)
      {
      ...
      override public function update() : void
      {
         ...
         if(this.timeout < 0)
         {
            ...
            this.timeout = this.TIMEOUTS[this.listPos] * this.BASE_TIMEOUT;
            _loc1_ = FlxU.random() > 0.5 ? -FlxG.scroll.x + FlxG.width - 8 : -FlxG.scroll.x - 8;
            if(Math.abs(PlayState.player.x - _loc1_) < 75)
            {
               return;
            }
            _loc2_ = -FlxG.scroll.y + FlxU.random() * FlxG.height;
            _loc3_ = new EnemyBird2(_loc1_,_loc2_);
