package com.newgrounds
{
   ...
   public class API
   {
      ...
      public static function loadScores(param1:String, param2:String = null, param3:String = null) : void
      {
         ...
         var _loc5_:ScoreBoard = getScoreBoard(param1);
         if(!_loc5_ || !_loc5_.id)
         {
      ...
      {
         var _loc4_:Object = param1.toObject();
         _loc4_.user_name = user_name;
         if(param1.id)
         {
         ...
         switch(getCommandName(param1.command_id))
         {
            ...
            case "preloadSettings":
               if(param1.medals)
               {
                  ...
                  if(!hasUserSession() && !debugMode)
                  {
                     ...
                     _loc8_ = loadLocal("medals_unlocked");
                     if(_loc8_)
                     {
               ...
               {
                  _loc11_ = getSaveGroupById(_saveGroupId);
                  if(_loc11_)
                  {
            ...
            case "postScore":
               if(param1.success)
               {
                  ...
                  _loc6_ = getScoreBoardById(param1.board);
                  if(_loc6_)
                  {
            ...
            case "unlockMedal":
               if(_medals)
               {
                  _loc10_ = getMedal(param1.medal_name);
                  if(_loc10_.unlocked)
                  {
                     return;
                  }
            ...
            case "loadSaveFile":
               if(param1.success)
               {
                  ...
                  _loc15_ = new SaveFile(_loc11_);
                  _loc15_.id = param1.file.save_id;
            ...
            case "lookupSaveFiles":
               ...
               if(Boolean(param1.success) && Boolean(param1.files))
               {
                  ...
                  while(_loc16_ < param1.files.length)
                  {
                     ...
                     _loc15_ = new SaveFile(getSaveGroupById(param1.group_id));
                     _loc15_.name = _loc17_.filename;
