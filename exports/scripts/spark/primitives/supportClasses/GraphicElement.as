package spark.primitives.supportClasses
{
   ...
   public class GraphicElement extends EventDispatcher implements IGraphicElement, IInvalidating, ILayoutElement, IVisualElement, IMXMLObject
   {
      ...
      {
         var _loc2_:Matrix = Boolean(param1) && Boolean(param1.matrix) ? param1.matrix.clone() : null;
         var _loc3_:Matrix3D = Boolean(param1) && Boolean(param1.matrix3D) ? param1.matrix3D.clone() : null;
      ...
      mx_internal function captureBitmapData(param1:Boolean = true, param2:uint = 4294967295, param3:Boolean = true, param4:Rectangle = null) : BitmapData
      {
         ...
         if(!this.layoutFeatures || !this.layoutFeatures.is3D)
         {
            ...
            _loc10_ = param3 ? this.displayObject.transform.matrix : MatrixUtil.getConcatenatedMatrix(this.displayObject);
            if(_loc10_)
            {
      ...
      private function get3DSnapshot(param1:Boolean = true, param2:uint = 4294967295, param3:Boolean = true) : BitmapData
      {
         ...
         var _loc12_:int = _loc5_.getChildIndex(this.displayObject);
         if(_loc5_ is Group)
         {
            Group(_loc5_).mx_internal::$removeChild(this.displayObject);
         }
         else
         {
            _loc5_.removeChild(this.displayObject);
         }
         ...
         if(_loc5_ is Group)
         {
            Group(_loc5_).mx_internal::$addChildAt(this.displayObject,_loc12_);
         }
         else
         {
            _loc5_.addChildAt(this.displayObject,_loc12_);
         }
      ...
      protected function invalidateDisplayObjectSharing() : void
      {
         if(this.parent)
         {
            Group(this.parent).invalidateGraphicElementSharing(this);
         }
      }
      ...
      public function invalidateProperties() : void
      {
         ...
         if(this.parent)
         {
            Group(this.parent).invalidateGraphicElementProperties(this);
         }
      }
      ...
      public function invalidateSize() : void
      {
         ...
         if(this.parent)
         {
            Group(this.parent).invalidateGraphicElementSize(this);
         }
      }
      ...
      public function invalidateDisplayList() : void
      {
         ...
         if(this.parent)
         {
            Group(this.parent).invalidateGraphicElementDisplayList(this);
         }
      }
      ...
      public function getBoundsXAtSize(param1:Number, param2:Number, param3:Boolean = true) : Number
      {
         ...
         var _loc5_:Matrix = this.mx_internal::getComplexMatrix(param3);
         if(!_loc5_)
         {
         ...
         var _loc6_:Point = MatrixUtil.fitBounds(param1,param2,_loc5_,this.preferredWidthPreTransform(),this.preferredHeightPreTransform(),this.minWidth,this.minHeight,this.maxWidth,this.maxHeight);
         if(!_loc6_)
         {
      ...
      public function setLayoutBoundsSize(param1:Number, param2:Number, param3:Boolean = true) : void
      {
         ...
         {
            _loc6_ = MatrixUtil.fitBounds(param1,param2,_loc4_,this.preferredWidthPreTransform(),this.preferredHeightPreTransform(),this.minWidth,this.minHeight,this.maxWidth,this.maxHeight);
            if(_loc6_)
            {
               param1 = _loc6_.x;
               param2 = _loc6_.y;
         ...
         {
            _loc7_ = this.mx_internal::_width;
            _loc8_ = this.mx_internal::_height;
            this.mx_internal::_width = param1;
            ...
            if(param1 != _loc7_)
            {
               this.mx_internal::dispatchPropertyChangeEvent("width",_loc7_,param1);
            }
            if(param2 != _loc8_)
            {
               this.mx_internal::dispatchPropertyChangeEvent("height",_loc8_,param2);
            }
            this.invalidateDisplayList();
         }
      }
