package mx.utils
{
   ...
   public final class MatrixUtil
   {
      ...
      {
         return getConcatenatedMatrixHelper(param1,false);
      }
      
      public static function getConcatenatedComputedMatrix(param1:DisplayObject) : Matrix
      {
         return getConcatenatedMatrixHelper(param1,true);
      }
      ...
      private static function getConcatenatedMatrixHelper(param1:DisplayObject, param2:Boolean) : Matrix
      {
         ...
         var _loc7_:ApplicationDomain = null;
         ...
         while(Boolean(param1) && Boolean(param1.transform.matrix))
         {
            ...
            {
               _loc6_ = param1["moduleFactory"];
               if((_loc6_) && _loc6_ !== lastModuleFactory && "info" in _loc6_)
               {
                  _loc7_ = _loc6_["info"]()["currentDomain"];
                  if((Boolean(_loc7_)) && _loc7_.hasDefinition("mx.core.UIComponent"))
                  {
                     uiComponentClass = Class(_loc7_.getDefinition("mx.core.UIComponent"));
                  }
                  lastModuleFactory = _loc6_;
               }
            }
            _loc5_ = Boolean(uiComponentClass) && param1 is uiComponentClass;
            if(param2 && _loc5_)
            {
               _loc3_.concat(param1[computedMatrixProperty]);
            }
            else
            {
